package com.colutti.restfulSpring.converter;
...
import com.colutti.restfulSpring.converter.mocks.MockPerson;
...
public class DozerConverterTest {
	...
	public void parseVOListToEntityTest() {
		List<Person> outputList = DozerConverter.parseListObjects(inputObject.mockEntityList(), Person.class);
